...
class Space:
    ...
    def __init__(self, height, width, number_of_hospitals):
    ...
    def available_spaces(self):
        ...
        for house in self.houses:
            if house in all_spaces:
                all_spaces.remove(house)
        for hospital in self.hospitals:
            if hospital in all_spaces:
                all_spaces.remove(hospital)
    ...
    def random_restart(self, maximum, image_prefix=None, log=False):
        ...
        for i in range(maximum):
            ...
            if image_prefix:
                self.output_image(f"output_images/{image_prefix}{str(i).zfill(3)}.png")
...
if __name__ == '__main__':
    ...
    s = Space(height=10, width=20, number_of_hospitals=3)
    for i in range(15):
